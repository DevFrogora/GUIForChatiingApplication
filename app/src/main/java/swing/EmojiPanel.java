...
class EmojiPanel{
	...
	void setDataOfTransferedCaret(JTextComponent textComponent,DefaultCaret globcaret,WrappedHtmlEditorKit kit,HTMLDocument doc,EmojiPanel emojipanelcustomclass,JPanel center,String username){
	...
	void pasteEmojiInTextPane(String stremojiurl)throws BadLocationException,IOException {
		Date now =new Date();
		kit.insertHTML(doc, doc.getLength(), "<font color='red'><u><b>"+this.username+"<b></u></font> : "+"<font  style='background-color:#000000; color:#ffffff; font-size: 6px;'>"+ now.toString()+"</font><br>"+"<img src="+stremojiurl+" alt=\"smileBlob\" width=\"40\" height=\"30\">", 0, 0, null);
